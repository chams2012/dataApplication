...
public class DataApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(DataApplicationApp.class);

    private final Environment env;

    public DataApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes dataApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DataApplicationApp.class);
